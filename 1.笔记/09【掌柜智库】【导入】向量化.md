...
flowchart LR
    ...
    style G fill:#ffff00,stroke:#4299e1,stroke-width:2px
...
![向量化节点流程图](images/向量化节点流程图.png)

##### process

定义 `node_bge_embedding` ，串联各个步骤。
